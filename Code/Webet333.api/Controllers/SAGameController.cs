...
namespace Webet333.api.Controllers
{
    ...
    public class SAGameController : BaseController
    {
        ...
        public SAGameController(IStringLocalizer<BaseController> Localizer, IOptions<ConnectionConfigs> ConnectionStringsOptions, IHostingEnvironment environment) : base(ConnectionStringsOptions.Value, Localizer)
        {
