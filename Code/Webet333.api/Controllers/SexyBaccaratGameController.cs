...
namespace Webet333.api.Controllers
{
    ...
    public class SexyBaccaratGameController : BaseController
    {
        ...
        public SexyBaccaratGameController(IStringLocalizer<BaseController> Localizer, IOptions<ConnectionConfigs> ConnectionStringsOptions, IHostingEnvironment environment) : base(ConnectionStringsOptions.Value, Localizer)
        {
