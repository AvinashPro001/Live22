...
namespace Webet333.api.Controllers
{
    ...
    public class PaymentGatewayController : BaseController
    {
        ...
        public PaymentGatewayController(IStringLocalizer<BaseController> Localizer, IOptions<ConnectionConfigs> ConnectionStringsOptions) : base(ConnectionStringsOptions.Value, Localizer)
        {
